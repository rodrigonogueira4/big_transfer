...
python -m bit_pytorch.train --name covid_`date +%F_%H%M%S` --model BiT-M-R50x1 --logdir /scratch/rfn216/temp/bit_logs --dataset covid_2classes  --datadir ./data/h5files  --batch 128 --batch_split 8 --base_lr 0.001 --eval_every 4  >> $RUNDIR/out.log 2>&1
